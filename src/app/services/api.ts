...
export async function getDrivers(filters?: { team?: string; search?: string }) {
  const mockDrivers = [
    ...
    { id: 3, name: "Charles Leclerc", number: 16, team: "Ferrari", nationality: "Monaco", age: 28, points: 15, wins: 0, podiums: 1, championships: 0, image: "/Driver Images/Charles.avif" },
    { id: 4, name: "Lewis Hamilton", number: 44, team: "Ferrari", nationality: "Great Britain", age: 41, points: 12, wins: 0, podiums: 0, championships: 7, image: "/Driver Images/Lewis.avif" },
    { id: 5, name: "George Russell", number: 63, team: "Mercedes", nationality: "Great Britain", age: 28, points: 25, wins: 1, podiums: 1, championships: 0, image: "/Driver Images/Russel.avif" },
    { id: 6, name: "Kimi Antonelli", number: 7, team: "Mercedes", nationality: "Italy", age: 19, points: 18, wins: 0, podiums: 1, championships: 0, image: "/Driver Images/Antonelli.avif" },
    { id: 7, name: "Lando Norris", number: 1, team: "McLaren", nationality: "Great Britain", age: 26, points: 10, wins: 0, podiums: 0, championships: 1, image: "/Driver Images/Norris.avif" },
    { id: 8, name: "Oscar Piastri", number: 81, team: "McLaren", nationality: "Australia", age: 25, points: 0, wins: 0, podiums: 0, championships: 0, image: "/Driver Images/Oscar.avif" },
    ...
    { id: 17, name: "Liam Lawson", number: 40, team: "Racing Bulls", nationality: "New Zealand", age: 24, points: 0, wins: 0, podiums: 0, championships: 0, image: "/Driver Images/Lawson.avif" },
    ...
    { id: 20, name: "Oliver Bearman", number: 50, team: "Haas F1 Team", nationality: "United Kingdom", age: 20, points: 6, wins: 0, podiums: 0, championships: 0, image: "/Driver Images/Bearman.avif" },
